...
class BlockSample(BaseModel):
    ...
    header2_remote_addr: str = Field("", description="2nd header announcer address")
    header2_remote_port: int = Field(0, description="2nd header announcer port")
    header3_remote_addr: str = Field("", description="3rd header announcer address")
    header3_remote_port: int = Field(0, description="3rd header announcer port")
